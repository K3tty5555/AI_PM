...
function CommandPalette({
  ...
  const commands: CommandItem[] = useMemo(() => {
    ...
    const toolCommands: CommandItem[] = [
      ...
      { id: "gap-research", label: "缺口讨论提纲", icon: HelpCircle, action: nav("/tools/gap-research"), group: "工具" },
      { id: "multi-review", label: "多视角审视", icon: Microscope, action: nav("/tools/multi-review"), group: "工具" },
