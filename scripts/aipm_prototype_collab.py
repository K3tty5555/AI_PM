...
"""
    css += r"""
/* Inspection-first layout: preserve a desktop viewport instead of shrinking pages into overview cards. */
.gallery{grid-template-columns:minmax(0,1fr);max-width:1920px;margin:0 auto;gap:20px;padding:20px 24px 48px}.frame-card{background:rgba(255,255,255,.08);box-shadow:0 12px 28px rgba(0,0,0,.18)}.frame-head{padding:11px 14px}.frame-head h2{font-size:16px}.frame-desc{min-height:36px;padding:8px 14px;color:#c4d2d5;font-size:12px}.frame-main{grid-template-columns:minmax(0,1fr) 240px;align-items:start;gap:14px;padding:0 14px 14px}.wire-canvas{width:100%;height:auto;min-height:0;aspect-ratio:16/9;overflow:auto;grid-auto-rows:minmax(48px,auto);align-content:stretch;padding:12px;gap:10px;border-color:#b6c8ca;background:#f4f8f8}.wire-block{height:100%;min-height:58px;padding:9px;color:#294047;background:#fff}.wire-block p,.wire-block span,.wire-list li span,.wire-list li b{color:#294047}.wire-section-title{font-size:11px}.wire-list{gap:5px}.wire-list li{height:32px;padding:6px 8px}.wire-list li span{font-size:11px}.wire-form label{font-size:11px}.wire-block button{min-height:30px;font-size:11px}.wire-table b,.wire-table span{font-size:10px}.wire-media{height:100%;min-height:150px}.frame-review{position:sticky;top:126px;align-self:start;gap:9px;min-height:260px;padding:12px;border:1px solid rgba(255,255,255,.24);border-radius:10px;background:rgba(255,255,255,.16)}.frame-review-head{display:flex;align-items:center;justify-content:space-between;gap:8px;padding-bottom:2px}.frame-review-head strong{font-size:13px}.frame-review-head span{color:#9edbd4;font-size:10px}.frame-review label{gap:5px;color:#d5e2e4;font-size:11px}.frame-review select,.frame-review textarea{border-color:rgba(255,255,255,.38);color:#f0f8f8;background:rgba(7,31,38,.76)}.frame-review select{height:36px;font-size:12px}.frame-review textarea{min-height:150px;padding:9px;font-size:12px;line-height:1.5}.frame-review textarea::placeholder{color:#9db1b5;opacity:1}.kind-feedback{min-height:64px}.wire-feedback{padding:8px}.wire-feedback p{font-size:11px}
@media(max-width:1450px){.gallery{padding-left:20px;padding-right:20px}.frame-main{grid-template-columns:minmax(0,1fr) 230px}.frame-review textarea{min-height:120px}}
@media(max-width:1120px){.frame-main{grid-template-columns:minmax(0,1fr)}.frame-review{position:static;min-height:0}.frame-review textarea{min-height:108px}}
@media(max-width:820px){.gallery{padding:12px}.wire-canvas{aspect-ratio:auto;min-height:520px}.frame-review{border-top:1px solid rgba(255,255,255,.24)}}
"""
