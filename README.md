...
│   ├── ai-pm-data-insight/   # 数据洞察与需求发现
│   ├── ai-pm-prototype/      # 原型生成
│   ├── ai-pm-review/         # 需求评审
│   ├── ai-pm-knowledge/      # 知识库管理
│   └── ai-pm-dashboard/      # 项目仪表盘
│
├── .claude/agent-team/       # 🤖 AI 代理团队（专业角色协作）
│   ├── orchestrator/         # 总协调者
│   ├── product-manager/      # 产品经理代理
│   ├── architect/            # 架构师代理
│   ├── ui-designer/          # UI设计师代理
│   ├── data-analyst/         # 数据分析师代理
│   └── tech-writer/          # 技术文档工程师代理
│
├── output/                   # 产出目录
│   ├── projects/             # 所有项目
│   │   ├── project-a-20260228/
...
| `/ai-pm dashboard` | 打开项目仪表盘 |
| `/ai-pm dashboard view {项目}` | 查看项目详情 |
