...
```bash
ls /Users/xiaowu/workplace/AI_PM/.github/workflows/ 2>/dev/null || echo "目录不存在，需要创建"
```

如不存在：`mkdir -p /Users/xiaowu/workplace/AI_PM/.github/workflows/`

**Step 2: 创建 release.yml**

创建 `/Users/xiaowu/workplace/AI_PM/.github/workflows/release.yml`：
