...
```bash
cd <AI_PM_ROOT>/app/src-tauri && ~/.cargo/bin/cargo build 2>&1 | grep "^error" | head -10
```
...
```bash
cd <USER_HOME>/workplace/AI_PM && git add app/src-tauri/src/providers/mod.rs
...
```bash
cd <USER_HOME>/workplace/AI_PM && git add app/src-tauri/src/providers/anthropic.rs
...
```bash
cd <USER_HOME>/workplace/AI_PM && git add app/src-tauri/src/providers/openai.rs
...
```bash
cd <USER_HOME>/workplace/AI_PM && git add app/src-tauri/src/providers/claude_cli.rs
...
```bash
cd <AI_PM_ROOT>/app/src-tauri && ~/.cargo/bin/cargo build 2>&1 | tail -3
```
...
```bash
cd <USER_HOME>/workplace/AI_PM && git add app/src-tauri/src/commands/stream.rs
...
```bash
cd <AI_PM_ROOT>/app && npx tsc --noEmit 2>&1 | head -20
```
...
```bash
cd <USER_HOME>/workplace/AI_PM && git add app/src/hooks/use-ai-stream.ts
...
```bash
cd <AI_PM_ROOT>/app && npx tsc --noEmit 2>&1 | grep "project-cache\|ProjectStageBar" | head -10
```

**Step 4: Commit**

```bash
cd <USER_HOME>/workplace/AI_PM && git add app/src/lib/project-cache.ts app/src/components/layout/ProjectStageBar.tsx
...
```bash
cd <AI_PM_ROOT>/app && npx tsc --noEmit 2>&1 | grep "Analysis" | head -10
```

**Step 8: Commit**

```bash
cd <USER_HOME>/workplace/AI_PM && git add app/src/pages/project/Analysis.tsx
...
```bash
cd <USER_HOME>/workplace/AI_PM && git add app/src/pages/project/Research.tsx app/src/pages/project/Review.tsx app/src/pages/project/Stories.tsx app/src/pages/project/Prd.tsx
...
```bash
cd <AI_PM_ROOT>/app && npx tsc --noEmit 2>&1
```
...
```bash
cd <USER_HOME>/workplace/AI_PM && git status
```
