...
source-project: 某产品融合洞察-20260305
created: 2026-03-05
confidence: high
---
...
- **考试视角**：学科某产品率横向柱图 + 年度趋势对比 + 月度趋势折线 + 规模效应 + 引入前后对比 + 场景饼图
- **作业视角**：使用深度漏斗（下载→扫描→讲评→查看报告）+ 讲评 vs 报告率对比 + 热力表
- **学科对比**：双轴图（考试某产品率 + 作业讲评率）+ 智批改能力矩阵 + 气泡图（作业量×讲评率×某产品率）
...
某 K12 教育平台学校维度数据洞察，考试和作业双产品均有使用数据的学校。单产品学校可裁剪对比 Tab。
