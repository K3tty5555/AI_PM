<!-- doctype: full -->
> 📎 **样本说明**：本文件为「全员评审 · 功能 PRD」风格样例（虚构产品），示意章节结构与用词风格。部分 2026-06 后约定（`doctype` 机读字段 / 影响范围 / 暂不纳入本期 / 复用对照表）以 `feishu-template.md` + `phase-5-prd.md` 流程为准；文中色值/数据均为示例值，按产品实际替换。
