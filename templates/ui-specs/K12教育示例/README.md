# K12 教育示例设计系统 (K12 Education Design System)

> 面向 K12 在线教育平台的现代化设计系统示例

## 概述

**K12 教育示例设计系统** 是一套专为 K12 在线教育场景打造的完整设计系统示例，涵盖了颜色、字体、间距、组件等全方位的设计令牌，旨在为教育类产品提供一致、专业、易用的视觉体验。
...
:root {
  ...
  --edu-text-tertiary: #888A8C;
  --edu-text-disabled: #B9BCBF;

  --edu-border-color: #D2D5D9;
  --edu-border-color-light: #DCDFE3;

  --edu-bg-page: #F0F3F7;
  --edu-bg-container: #FFFFFF;
}
```
...
**K12 教育示例设计系统** © 2026 AI_PM Project
