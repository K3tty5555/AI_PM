...
| project | `project_edu_business_knowledge.md` | 某教育 AI 助手 · 业务知识沉淀 | V1.1/V1.2/V1.3 PRD 工作期间形成的业务规律：4 类题库结构、场景分组对话上下文规则、意图分发分层、组卷搜题边界、教师权限模型、教育场景 AI 自主性等级、B 端 Agent 上下文穿透原则。 |
| project | `project_edu_pilot_schools.md` | 某教育 AI 助手 · 试点学校 | 3 所种子学校名单 + 6/1 试点首批 Go Live 对齐 |
| project | `project_edu_roadmap_2026.md` | 某教育 AI 助手 · 2026 产品路标 | 2026-04-20 更新至 v1.6：阶段验收改名+时间点移至6/22；暑假验收通过可加人力 |
| project | `project_edu_status_20260425.md` | 某教育 AI 助手 · 当前状态快照（2026-04-25） | V1.1/V1.2/V1.3 三份 PRD 已定稿、原型可交互、docx 带截图导出；用户接管 V1.1 后续修订；模板已多领域化。下一步等待 V1.1 用户修订后续动作。 |
| project | `project_edu_super_agent.md` | 某教育 AI 助手项目 | 某 K12 教育平台 AI 助手 Copilot 项目的完整上下文——三场景 Skill 定义、数据安全红线、需求池覆盖分析、团队分工 |
...
| reference | `reference_edu_codebase.md` | 某教育 AI 助手 · 工程代码仓位置 | 某 K12 教育平台 AI 助手实际工程代码仓路径，用于查看研发进度和实现细节 |
...
| user | `user_role_zhixue.md` | 用户角色 - 某 K12 教育平台产品总监 | 用户是某 K12 教育平台产品总监，关注 AI 时代教育产品新机会，正在做某教育 AI 助手竞品分析 |
