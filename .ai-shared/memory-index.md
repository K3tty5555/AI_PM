...
| user | `user_prd_writing_style.md` | PRD写作风格（武凯迪） | 武凯迪 PM 风格——基于 V1/V2/V3/V1.7 PRD 蒸馏的结构、语气、判断标准。配套 `.claude/skills/ai-pm/references/pm-judgment-card.md` 是 PM Agent 内核。 |
